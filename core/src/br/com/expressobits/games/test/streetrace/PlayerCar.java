...
public class PlayerCar extends Actor{
	...
	private void moveToLane(int lane) {
		...
		switch (lane) {
			case 0:
				addAction(Actions.moveTo(getX(), trafficGame.lane0 - getHeight()/2, 0.5f));
				break;
			case 1:
				addAction(Actions.moveTo(getX(), trafficGame.lane1 - getHeight()/2, 0.5f));
				break;
			case 2:
				addAction(Actions.moveTo(getX(), trafficGame.lane2 - getHeight()/2, 0.5f));
				break;
		}
	}
